...
const Homepage = () => {
    ...
    // Reusable collection section renderer
        ...
        <div className="bg-black min-h-screen text-white">
            ...
            <div className="relative h-screen min-h-[500px] overflow-hidden">
                        ...
                        <div className="max-w-2xl space-y-6 animate-slide-up">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                <button
                                    ...
                                    onClick={() => window.scrollTo({ top: trendingVisibleRef.current.offsetTop, behavior: "smooth" })}
                                >
                                    Explore Collection
                                </button>
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/2 sm:w-1/3 max-w-[400px] md:max-w-[600px] hidden lg:block animate-float">
                    <img
                        src={image} // Replace with actual watch image
                        alt="Premium Watch"
